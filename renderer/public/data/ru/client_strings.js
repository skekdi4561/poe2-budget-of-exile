...
export default {
  ...
  MANA_TAG: 'Мана',
  ARMOUR_TAG: 'Броня',
  EVASION_TAG: 'Уклонение',
  ENERGY_SHIELD_TAG: 'Энергетический щит',
  PHYSICAL_TAG: 'Физический',
  FIRE_TAG: 'Огонь',
  COLD_TAG: 'Холод',
  LIGHTNING_TAG: 'Молния',
  CHAOS_TAG: 'Хаос',
  ATTACK_TAG: 'Атака',
  CASTER_TAG: 'Чародейский',
  SPEED_TAG: 'Скорость',
  ATTRIBUTE_TAG: 'Характеристика',
  MINION_TAG: 'Приспешник',
  // [Array]
